...
if (isset($_POST['insert'])) {
    ...
    $sql = $userdata->addfeedback($name, $email, $date, $message);
    if ($sql) {
                    ...
                    <div class="site-branding d-flex align-items-center">
                        ...
                        <nav class="site-navigation d-flex justify-content-end align-items-center">
                            <ul class="d-flex flex-column flex-lg-row justify-content-lg-end align-content-center" style="overflow:visible;">
                                ...
                                <li><a href="viewflight.php">Car Schedule</a></li>
                ...
                <div class="form-wrap shadow-lg">
				   <div class="text-center">
                    ...
                    <div class="form-group col-6 col-lg-6">
						...
						<div class="text-center"><input type="submit" name="insert" value="Send" class="btn gradient-bg mt-5"></div>
