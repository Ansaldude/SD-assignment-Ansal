...
<html lang="en">
  <head>
    ...
    <title>Admin | View Cardetails</title>
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
						...
						tbody{color:black}
	                  	  	  ...
	                  	  	  <h4><i class="fa fa-angle-right"></i> All Car Details </h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
...
while ($row = mysqli_fetch_array($sql)) {
  ...
  <td>
        <a href="updatecar.php?id=<?php echo htmlentities($row['carid']); ?>" class="btn btn-primary btn-xs">Edit</a>
         <a href="viewcar.php?del=<?php echo htmlentities($row['carid']); ?>" class="btn btn-danger btn-xs" onClick="return confirm('Do you really want to delete');" >Delete</a>
       </td>
  </tr>
  <?php
