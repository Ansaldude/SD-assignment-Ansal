				   ...
				   <div class="text-center">
                    ...
                    <form action='' method="post" role="form"class="form">
                        ...
                        <label>Postal Code</label>
						 <input type="text" class="form-control" name="pcode" required placeholder="Postal Code"
						...
						<div class="form-group  col-6 col-lg-6">
                        <label>Card No.</label>
							<input type="text" class="form-control" name="cardno" required placeholder="Card NO."
                            data-msg="Please enter a valid number" />
							<div class="validation"></div>
						</div>
                        <div class="form-group  col-6 col-lg-6">
                        <label>Expiry Date</label>
							<input type="date" class="form-control" name="edate" required placeholder="Expirey Date"
                            data-msg="Please enter a valid number" />
							<div class="validation"></div>
						</div>
						...
						<div class="text-center"> <input type="submit" name="insert" value="Pay" class="btn gradient-bg mt-5"></div>
