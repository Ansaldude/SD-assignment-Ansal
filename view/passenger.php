...
if (isset($_POST['insert'])) {
    ...
    $sql = $userdata->addpassenger($name, $address, $contact, $email);
    if ($sql) {

        echo "<script>alert('Passenger data added sucessfully.');</script>";
                ...
                <div class="form-wrap shadow-lg">
				   <div class="text-center">
                    ...
                    <form action='' method="post" role="form"class="form">
						...
						<div class="form-group  col-6 col-lg-6">
						 <input type="text" class="form-control" name="contact" required placeholder="Contact No."
                          data-msg="Please enter a valid Conatct NO" />
						 <div class="validation"></div>
						</div>
						<div class="form-group  col-6 col-lg-6">
						...
						<div class="text-center"> <input type="submit" name="insert" value="Continue" class="btn gradient-bg mt-5"></div>
